...
cp "_build_linux/lib/libMagick++-7.Q16HDRI.a" "${OUTPUT}/Libraries/macOS/"
cp "_build_linux/lib/libMagickCore-7.Q16HDRI.a" "${OUTPUT}/Libraries/macOS/"
cp "_build_linux/lib/libMagickWand-7.Q16HDRI.a" "${OUTPUT}/Libraries/macOS/"
