...
if [[ $OS = 'Darwin' ]]; then
    ...
    ./configure --disable-shared --with-png=no --with-bzip2=no --with-harfbuzz=no --with-brotli=no --with-zlib=no \
        --prefix="${PREFIX}"
...
interactive_prompt \
    ...
    "Library: ${OUTPUT_LIB}/${LIBRARY_NAME}/libfreetype.a"
